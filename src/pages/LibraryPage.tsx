  ...
  if (!tradition || !lib) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <p className="text-muted-foreground">Biblioteca não encontrada.</p>
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm">
            Textos sagrados — {tradition.name} {tradition.icon}
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground/60 mt-2">
                    {work.chapters.length} {work.chapters.length === 1 ? "capítulo" : "capítulos"}
                  </p>
                </div>
              </Link>
            </motion.div>
        ...
        {lib.glossary.length > 0 && (
          <motion.section
            ...
            className="mt-12"
          >
            <h2 className="mb-4 font-display text-xl font-semibold text-foreground">Glossário</h2>
